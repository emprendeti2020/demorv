  ...
  cargarDatos(): void {
    this.activatedRoute.params
        .subscribe(params => {
          ...
          if(rut){
            this.paciente = {rut: '100200300', nombre: 'Rosario Rosales', email: 'rosario@gmail.com', whatsapp: '+56 972342123', fechaNacimiento: '10/08/1994', edad: '27', calle: 'Calle Salvador', numero: '24', comuna: 'Natales', ciudad: 'Puerto Natales', preDiagnostico: '', diagnostico: ''}; 
          }
